...
import com.ajex.invoice.staging.integration.AIMSInvoiceService;
...
public class OracleInvoiceStatusConsumer {
    ...
    private final AIMSInvoiceService aimsInvoiceService;
    ...
    public void oracleInvoiceListener(String sOracleInvoice) {
        log.info("received :: {}", sOracleInvoice);
        try {
            ...
            aimsInvoiceService.updateOracleInvoiceResponse(oracleInvoiceStatusResponse);
